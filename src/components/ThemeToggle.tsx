...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({
  ...
  // Namespaced IDs for SVGs
  const maskA = `mask_a_${uid}`;
  const gradB = `grad_b_${uid}`;
  const gradC = `grad_c_${uid}`;
  const gradD = `grad_d_${uid}`;
  const gradE = `grad_e_${uid}`;
  const patF = `pat_f_${uid}`;
  const gradG = `grad_g_${uid}`;
  const gradH = `grad_h_${uid}`;
  const gradI = `grad_i_${uid}`;
  const gradJ = `grad_j_${uid}`;
  const gradK = `grad_k_${uid}`;
  const imgL = `img_l_${uid}`;

  const gradAA = `grad_aa_${uid}`;
  const gradBB = `grad_bb_${uid}`;
  const gradCC = `grad_cc_${uid}`;
  const clipDD = `clip_dd_${uid}`;

  return (
    <div className={`inline-flex items-center gap-2 select-none ${className}`}>
      {showLabel && (
        <span className="text-[11px] font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
          {isDark ? 'Night' : 'Day'}
        </span>
      )}
      <button
      ...
      >
        <span className="toggle__content">
          {/* First backdrop with daytime clouds */}
          <svg
            aria-hidden="true"
          ...
          {/* Pilot bear container (flies during daytime) */}
          <span aria-hidden="true" className="pilot__container">
            <span className="pilot-bear">
              ...
              >
                ...
                <path fill={`url(#${gradC})`} fillOpacity=".4" d="M415 372.657 643.398 213v159.657H415Z" />
                ...
                <ellipse cx="59.871" cy="539.966" fill={`url(#${gradD})`} rx="59.871" ry="38.806" />
                <path fill="#5B5B5B" d="M106.438 441.29h53.219v199.571h-53.219z" />
                <path fill="#D9D9D9" fillRule="evenodd" clipRule="evenodd" d="M1359.3 372.549H159.657v337.053H949.06l410.24-236.853v-100.2Z" />
                <path fill={`url(#${gradE})`} fillOpacity=".4" fillRule="evenodd" clipRule="evenodd" d="M1359.3 372.549H159.657v337.053H949.06l410.24-236.853v-100.2Z" />
                <path fill={`url(#${patF})`} d="M281.617 408.028h263.877v263.877H281.617z" />
                <path fill="#FF0B0B" d="M192.919 709.602h443.492V798.3H192.919z" />
                <path fill={`url(#${gradG})`} fillOpacity=".3" d="M192.919 709.602h443.492V798.3H192.919z" />
                <path fill="#FF0B0B" d="M192.919.016h443.492v88.698H192.919z" />
                <path fill={`url(#${gradH})`} fillOpacity=".28" d="M192.919.016h443.492v88.698H192.919z" />
                <path fill="#FF0B0B" d="M1175.25 396.941h221.746v44.349H1175.25z" />
                <path fill={`url(#${gradI})`} fillOpacity=".2" d="M1175.25 396.941h221.746v44.349H1175.25z" />
                <path fill="#F20000" d="M1301.65 212.892H1448l-90.92 159.657h-148.57l93.14-159.657Z" />
                <path fill={`url(#${gradJ})`} fillOpacity=".2" d="M1301.65 212.892H1448l-90.92 159.657h-148.57l93.14-159.657Z" />
                <circle cx="476.754" cy="869.259" r="68.741" fill={`url(#${gradK})`} />
                <path fill="#494949" d="M223.963 88.714h33.262v620.888h-33.262zm345.923 0h33.262v620.888h-33.262z" />
                <defs>
                  <linearGradient id={gradB} x1="682" x2="860" y1="205" y2="182" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#fff" />
                    <stop offset=".375" stopColor="#fff" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient id={gradC} x1="444" x2="643" y1="325" y2="321" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#fff" />
                    <stop offset=".443" stopColor="#fff" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient id={gradD} x1="0" x2="119.743" y1="541.075" y2="541.075" gradientUnits="userSpaceOnUse">
                    <stop offset=".25" stopColor="#FF2626" />
                    <stop offset=".25" />
                  </linearGradient>
                  <linearGradient id={gradE} x1="1232" x2="160" y1="521" y2="521" gradientUnits="userSpaceOnUse">
                    <stop />
                    <stop offset="1" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient id={gradG} x1="626" x2="208" y1="754" y2="754" gradientUnits="userSpaceOnUse">
                    <stop />
                    <stop offset="1" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient id={gradH} x1="636" x2="193" y1="44" y2="44" gradientUnits="userSpaceOnUse">
                    <stop />
                    <stop offset="1" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient id={gradI} x1="1380" x2="1028" y1="419" y2="419" gradientUnits="userSpaceOnUse">
                    <stop />
                    <stop offset="1" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient id={gradJ} x1="1362" x2="1156" y1="273" y2="279" gradientUnits="userSpaceOnUse">
                    <stop />
                    <stop offset="1" stopOpacity="0" />
                  </linearGradient>
                  <radialGradient
          ...
          {/* Second backdrop with daytime clouds */}
          <svg
            aria-hidden="true"
            className="toggle__backdrop"
            xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Indicator with Sun & Moon (craters) */}
          ...
          {/* Third backdrop with night stars (twinkling) */}
          <svg
            aria-hidden="true"
            className="toggle__backdrop"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="astrobear__container">
            <span className="astrobear">
              ...
              >
                ...
                <circle cx="158" cy="143" r="140" fill={`url(#${gradAA})`} fillOpacity=".2" />
                ...
                <circle cx="158" cy="143" r="140" fill={`url(#${gradCC})`} stroke="#000" strokeWidth="6" />
                <g clipPath={`url(#${clipDD})`}>
                  <path
                    fill="#F5D949"
                    stroke="#000"
                    strokeWidth="6"
                ...
                />
                <defs>
                  <linearGradient id={gradAA} x1="158" x2="158" y1="0" y2="286" gradientUnits="userSpaceOnUse">
                    <stop offset=".219" />
                    <stop offset="1" stopColor="#fff" />
                  </linearGradient>
                  <linearGradient id={gradBB} x1="254" x2="100" y1="419" y2="325" gradientUnits="userSpaceOnUse">
                    <stop stopOpacity=".98" />
                    <stop offset="1" stopOpacity="0" />
                  </linearGradient>
                  <radialGradient
